...
export { analyticstatData, analyticTopPages, BestSelling, TopSelling, Recentelling, statData, cryptostatData,cryptoCurrencies, cryptoTopPerformers, cryptoNewsFeed };
